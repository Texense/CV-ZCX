...
\makerubrichead{Publication List}
...
\printbibliography[heading={subbibliography},title={Manuscripts},type=article]

%\printbibliography[heading={subbibliography},title={Conference Proceedings},type=inproceedings]

\printbibliography[heading={subbibliography},title={Ongoing Work},filter={booksandchapters}]
